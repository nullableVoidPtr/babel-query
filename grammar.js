...
const unescape = (str) => str.replace(/\\(.)/g, (_, ch) => {
    switch (ch) {
        case 'b': return '\b';
        case 'f': return '\f';
        case 'n': return '\n';
...
const grammar = {
    ...
    ParserRules: [
        ...
        { "name": "selectors", "symbols": ["selector", "selectors$ebnf$1"], "postprocess": d => d[1].length === 0
                ? d[0]
                : {
                    type: "list",
                    list: [d[0], ...d[1].map(
        ...
        { "name": "selector", "symbols": ["selector", "combinator", "sequence"], "postprocess": ([left, combinator, right], _, reject) => {
                if (left === null ||
                    right === null) {
                    return reject;
                }
        ...
        { "name": "sequence", "symbols": ["sequence$ebnf$1", "sequence$ebnf$2"], "postprocess": ([startAtom, specifierAtoms], _, reject) => {
                if (startAtom === null &&
        ...
        { "name": "field", "symbols": [{ "literal": "." }, "field$subexpression$1"], "postprocess": d => d[1][0]
        },
        ...
        { "name": "sequence", "symbols": ["sequence$ebnf$3", "field", "sequence$ebnf$4"], "postprocess": ([subject, key, specifiers]) => {
                let specifier = null;
        ...
        { "name": "startAtom", "symbols": ["identifier"], "postprocess": d => ({
                type: "type",
                name: d[0],
            })
        },
        ...
        { "name": "specifierAtom", "symbols": ["specifierAtom$subexpression$1"], "postprocess": d => d[0][0]
        },
        ...
        { "name": "float", "symbols": ["float$ebnf$1", "float$ebnf$2", { "literal": "." }, "float$ebnf$3"], "postprocess": d => parseFloat(((d[0] === "-") ? "-" : "") +
                d[1].join("") + "." + d[3].join(""))
        },
        ...
        { "name": "integer", "symbols": ["integer$ebnf$1", "integer$ebnf$2"], "postprocess": d => parseInt(((d[0] === "-") ? "-" : "") +
                d[1].join(""))
        },
        ...
        { "name": "attrNumOps", "symbols": ["attrNumOps$subexpression$1"], "postprocess": d => d[0].join("")
        },
        ...
        { "name": "attrStrOps", "symbols": ["attrStrOps$subexpression$1"], "postprocess": d => d[0].join("")
        },
        ...
        { "name": "attrValue", "symbols": ["attrValue$subexpression$1"], "postprocess": ([[[names, _0, operator, _1, right]]], _, reject) => {
                if (names === null ||
                    operator === null ||
                    right === null) {
                    return reject;
        ...
        { "name": "attrValue", "symbols": ["attrName"], "postprocess": d => ({
                type: "attribute",
                names: d[0]
            })
        },
        ...
        { "name": "string", "symbols": [{ "literal": "\"" }, "string$ebnf$1", { "literal": "\"" }], "postprocess": d => unescape(d[1].join(''))
        },
        { "name": "string$ebnf$2", "symbols": [] },
        { "name": "string$ebnf$2", "symbols": ["string$ebnf$2", /[^']/], "postprocess": (d) => d[0].concat([d[1]]) },
        { "name": "string", "symbols": [{ "literal": "'" }, "string$ebnf$2", { "literal": "'" }], "postprocess": d => unescape(d[1].join(''))
        },
        ...
        { "name": "regex", "symbols": [{ "literal": "/" }, "regex$ebnf$1", { "literal": "/" }, "regex$ebnf$2"], "postprocess": d => new RegExp(d[1].join(""), d[3] ?? "")
        },
        ...
        { "name": "class", "symbols": ["class$subexpression$1"], "postprocess": ([[name]]) => ({
                type: "class",
                name,
            })
        },
        ...
        { "name": "nthExpr", "symbols": ["nthExpr$ebnf$1", { "literal": "n" }, "nthExpr$ebnf$2"], "postprocess": d => {
                let multiplier = 1;
                if (d[0] !== null) {
                    if (d[0][0] === "-") {
                        multiplier = -1;
        ...
        { "name": "nthExpr", "symbols": ["nthExpr$string$1"], "postprocess": _ => ({
                type: "nthExpr",
                multiplier: 2,
                offset: 1,
            })
        ...
        { "name": "nthExpr", "symbols": ["nthExpr$string$2"], "postprocess": _ => ({
                type: "nthExpr",
                multiplier: 2,
                offset: 0,
            })
        },
        { "name": "nthExpr", "symbols": ["integer"], "postprocess": ([offset]) => ({
                type: "nthExpr",
                multiplier: 0,
                offset,
            })
        ...
        { "name": "logicalSelector", "symbols": ["logicalSelector$subexpression$1", { "literal": "(" }, "_", "selectors", "_", { "literal": ")" }], "postprocess": (d, _, reject) => {
                if (d[3] === null) {
                    return reject;
                }
                return ({
        ...
        { "name": "relativeSelector", "symbols": ["relativeSelector$ebnf$1", "selector"], "postprocess": ([combinator, selector], _, reject) => {
                if (selector === null) {
                    return reject;
                }
        ...
        { "name": "logicalSelector", "symbols": ["logicalSelector$string$1", { "literal": "(" }, "_", "relativeSelector", "logicalSelector$ebnf$1", "_", { "literal": ")" }], "postprocess": (d) => {
                const list = [];
        ...
        { "name": "logicalSelector", "symbols": ["logicalSelector$string$2", { "literal": "(" }, "_", "selectors", "_", { "literal": ")" }], "postprocess": (d, _, reject) => {
                if (d[3] === null) {
                    return reject;
                }
                return ({
        ...
        { "name": "nthChild", "symbols": ["nthChild$string$1", "nthExpr", { "literal": ")" }], "postprocess": d => ({
                type: 'nth-child',
                index: d[1],
            })
        },
        ...
        { "name": "nthLastChild", "symbols": ["nthLastChild$string$1", "nthExpr", { "literal": ")" }], "postprocess": d => ({
                type: 'nth-child',
                index: -d[1],
            })
        },
