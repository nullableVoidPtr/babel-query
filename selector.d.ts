export declare type CombinatorType = "sibling" | "adjacent" | "child" | "descendant";
...
export declare type AttributeBinOps = "=" | "!=" | ">" | "<" | ">=" | "<=" | "^=" | "$=" | "*=";
...
export declare type NodeClass = "statement" | "expression" | "declaration" | "function" | "pattern" | "scope";
...
export declare type PseudoSelector = RootPseudoSelector | ClassPseudoSelector | IsPseudoSelector | NotPseudoSelector | HasPseudoSelector | NthChildPseudoSelector | OnlyChildPseudoSelector;
export declare type Selector = ListSelector | ComplexSelector | CompoundSelector | WildcardSelector | TypeSelector | AncestrySelector | AttributeSelector | PseudoSelector;
